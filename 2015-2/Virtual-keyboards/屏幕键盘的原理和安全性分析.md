...
6、实际应用：
猜想：也许可以通过某种方式获得屏幕软键盘信息或软键盘图片，配合同一个局域网内捕捉到的Network中的POST包，破解出用户密码。
实验环境：校园网CUC
...
![附加码](http://image17-c.poco.cn/mypoco/myphoto/20151212/20/17863501720151212200816040_640.jpg?663x298_130)

![附加码抓包1](http://image17-c.poco.cn/mypoco/myphoto/20151212/20/17863501720151212200843017_640.jpg?390x56_130)

![附加码抓包2](http://image17-c.poco.cn/mypoco/myphoto/20151212/20/17863501720151212201117052_640.jpg?689x69_130)

可以看出在network包中就可以获得附加码的明文，这也让输入附加码的这个操作变的不是很有意义。
...
*小笔记*
1 建设银行的附加码判别是前端判别。
2 CCB_PWD_MAP_GIGEST不是固定每几分钟变一次，可能随机生成了随机的时间。
3 掌握好做网站的度和用户体验好难，因为你要在考虑网站安全性的同时，考虑到用户体验。而操作过于复杂往往不是用户想要的。

12/2/2015 9:32:35 AM 
